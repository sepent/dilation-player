...
init(){let instance=this;let icons=this.app.config.get('icons',!1);let elLoaderIcon=this.app.config.get('elements.loaderModalIcon',!0);let elPlayerIcon=this.app.config.get('elements.playerModalIcon',!0);let runner=this.app.config.runner(!0);elPlayerIcon.html(icons.playerModal);elLoaderIcon.html(icons.loaderModal);runner.listen('loadstart',function(e){instance.toggle({loader:!0})});runner.listen('play',function(){instance.toggle()});runner.listen('pause ended',function(){instance.toggle()});runner.listen('timeupdate ',function(e){instance.toggle({loader:!1})});runner.listen('loadeddata',function(e){instance.toggle({loader:!1})});runner.listen('progress',function(){instance.toggle({loader:!0})});instance.toggle();return this}
...
progressTimerTooltipText.css('left',tleft+'px')}else{progressTimerTooltipText.active(!1);progressTimerTooltipImage.active(!1)}});runner.listen('loadeddata',function(e){helper.display()});return this}
